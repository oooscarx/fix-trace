...
fn fixture_model() -> Model {
    ...
    let summary = SessionSummary {
        ...
        project_path: "/tmp/parser-repair".to_owned(),
    ...
    let view = SessionView {
        ...
        actions: vec![
            ActionView {
                ...
                replayable: true,
                can_rerun: true,
                reads: vec!["config/parser.toml".to_owned()],
                writes: vec!["config/parser.toml".to_owned()],
            ...
            ActionView {
                ...
                replayable: true,
                can_rerun: true,
                reads: vec!["scripts/start.sh".to_owned()],
                writes: vec!["scripts/start.sh".to_owned()],
                resource_access_opaque: false,
                note: None,
            },
        ],
    ...
    model.sessions = vec![
        ...
        SessionSummary {
            ...
            project_path: "/tmp/cli-timeout".to_owned(),
